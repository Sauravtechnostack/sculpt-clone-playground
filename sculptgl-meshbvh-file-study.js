...
function init() {
	...
	window.addEventListener( 'pointerup', e => {
		// the expression mouseState = Boolean(e.buttons & 3) will set the mouseState variable to true if either the primary or secondary mouse button is pressed, and false otherwise.
		mouseState = Boolean( e.buttons & 3 );
